import { CalendarClock, CheckCircle2, CircleDollarSign, Clock, Edit3, MessageCircle, PlayCircle, RotateCcw, Scissors, UserRound, XCircle } from 'lucide-react'
...
export default function AppointmentCard({ appointment, onStatus, onReschedule }) {
